...
/**
 * Based on org.hibernate.validator.resourceloading.PlatformResourceBundleLocator.java
 * (hibernate-validator 4.3.0.Final)
 * 
 * We use a separate implementation here
 * to be independent of the (Hibernate) Validator implementation
 * 
 * @author hapke
 */
/**
...
public class PlatformResourceBundleLocator implements ResourceBundleLocator {
	...
	public ResourceBundle getResourceBundle(Locale locale) {
		...
		if ( rb != null ) {
			log.fine( "%s found."+ bundleName );
		}
		else {
			log.fine( "%s not found."+ bundleName );
		}
		return rb;
	}
